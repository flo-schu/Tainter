...
# njob = 1
# params = np.loadtxt("chunk_1.txt", delimiter=",")  # keine Probleme

njob = 11
params = np.loadtxt("chunk_11.txt", delimiter=",")  # große Probleme
...
data = np.array(data)
np.savetxt("/chunk_" + str(njob).zfill(4) + ".txt", data,
           delimiter=",", newline="\n")
