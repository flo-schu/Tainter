...
\input{../1_content/01_introduction.tex}

\section{Methods}
\input{../1_content/02_methods.tex}

\section{Results}
\input{../1_content/03_results.tex}

\section{Discussion}
\input{../1_content/04_discussion.tex}

\section{Conclusion}
\input{../1_content/05_conclusion.tex}
